...
int numParserErrors ; /* number of parser errors */
...
extern int startScanner(BufferPointer sc_buf);
...
int main4Parser(int argc, char** argv) {
	...
	int numParserErrors = 0;			/* Initializes the errors */

	int loadsize = 0; /*the size of the file loaded in the buffer */
	char* source;

	/*check for the correct arrguments-source file name */
	if (argc <= 1) {
